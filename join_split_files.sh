...
cat vendor_boot/dtb/06_dtbdump_Qualcomm_Technologies,_Inc._Khajeq_SoC.dtb.* 2>/dev/null >> vendor_boot/dtb/06_dtbdump_Qualcomm_Technologies,_Inc._Khajeq_SoC.dtb
rm -f vendor_boot/dtb/06_dtbdump_Qualcomm_Technologies,_Inc._Khajeq_SoC.dtb.* 2>/dev/null
